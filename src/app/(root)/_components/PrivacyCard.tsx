...
const PrivacyCard=({card}:{card:CardDetailTypes})=>{
    ...
    return(
        <>
            <div className={`px-8 py-8 w-full  h-[300px] rounded-[15px]   privacy-card ${card.cardType==="basic"&&"bg-[#ffffff] text-[#696974]"} ${card.cardType==="standard"&&"violet-bg-gradient text-[#ffffff]"} ${card.cardType==="gold"&&"slate-bg-gradient text-[#ffffff]"}`}>
